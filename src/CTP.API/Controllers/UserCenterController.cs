...
{   
    ...
    public class UserCenterController : BaseController
    {
        ...
        public string RegisterUserQuery(string userId)
        {
            return ListInvork<string>(() =>
                          {
                              RequesList<RegisterUser> registerUser = new RequesList<RegisterUser>()
                              {
                                  isSec = 0,
                                  Model = new RegisterUser { UserId = userId }
                              };
        ...
        /// <returns></returns>
        [HttpPost("RegisterUserAdd")]
        public string RegisterUserAdd(string userId, string pwd)
        {
            return TextInvork<string>(() =>
            {
                int b = Math.Abs(Guid.NewGuid().GetHashCode());
                RequesList<List<RegisterUser>> registerUser = new RequesList<List<RegisterUser>>
                {
                    isSec = 0,
                    Model = new List<RegisterUser>() { new RegisterUser {
                          AutoNo = b,
                         UserId=userId,
                         UserPwd=pwd
  }
        ...
        [HttpPost("RegisterUserAdd1")]
        public string RegisterUserAdd1([FromBody]Type aaaaa)
        {
        ...
        public string RegisterUserDelete(string userId)
        {
            return TextInvork<string>(() =>
            {
                RequesList<RegisterUser> registerUser = new RequesList<RegisterUser>
